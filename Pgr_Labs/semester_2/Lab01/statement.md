### Lab01: Generators and Iterators

Create two functions that demonstrate your understanding of:

1.  Generators - to produce an infinite sequence of values.
2.  Iterators with a timeout - to consume an iterator for a limited time.
